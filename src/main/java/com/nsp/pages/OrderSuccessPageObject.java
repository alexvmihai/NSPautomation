...
public class OrderSuccessPageObject extends BasePageObject<OrderSuccessPageObject>{
    private By orderReceivedHeader = By.xpath(".//*[@id='top']/body/div[2]/div/div[2]/div/div[2]/div[1]/h1");
    private By thankYouHeader = By.xpath(".//*[@id='top']/body/div[2]/div/div[2]/div/div[2]/h2");
    private By orderNumber = By.xpath(".//*[@id='top']/body/div[2]/div/div[2]/div/div[2]/p[1]/a");
